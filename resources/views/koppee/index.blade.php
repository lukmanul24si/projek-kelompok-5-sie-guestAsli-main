...
<body>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu text-capitalize">
                                @if(Auth::user()->role == 'seller')
                                    <a href="{{ url('/my-shop') }}" class="dropdown-item">Kelola Toko</a>
                                @else
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    <p>Kami hadir sebagai jembatan antara produsen lokal berbakat dengan konsumen yang menghargai kualitas.</p>
                ...
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    <p>Membantu pertumbuhan ekonomi masyarakat secara langsung.</p>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Produk Otentik</h5>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Harga Kompetitif</h5>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Mendukung Ekonomi Lokal</h5>
    ...
    <div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        ...
        <div class="container-fluid text-center text-white border-top mt-4 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <p class="mb-2">Copyright &copy; <a class="font-weight-bold" href="#">BogengStore</a>. All Rights Reserved.</p>
        </div>
    </div>
